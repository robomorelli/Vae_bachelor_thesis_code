...
def train_vae(name_fold, name_weights , dictionary, w, ind_w, intermediate_dim, act_fun, latent_dim, kernel_max_norm,
              lr, epochs, weight_KL_loss, batch_size, cols_sel,
...
#################################################################################################à
        ...
        L_RecoProb_1 = CustomIndividualLogNorLayer_1(name='RecoNLL_{}'.format(cols_sel[0]))([x_DNN_input,L_par1,
                                                                      L_par2,L_par3])

        L_RecoProb_2 = CustomIndividualLogNorLayer_2(name='RecoNLL_{}'.format(cols_sel[1]))([x_DNN_input,L_par1,
                                                                      L_par2,L_par3])

        L_RecoProb_3 = CustomIndividualLogNorLayer_3(name='RecoNLL_{}'.format(cols_sel[2]))([x_DNN_input,L_par1,
                                                                      L_par2,L_par3])

#         L_RecoProb_4 = CustomIndividualLogNorLayer_4(name='RecoNLL_{}'.format(cols_sel[3]))([x_DNN_input,L_par1,
#                                                                       L_par2,L_par3])

#         L_RecoProb_5 = CustomIndividualLogNorLayer_5(name='RecoNLL_{}'.format(cols_sel[4]))([x_DNN_input,L_par1,
#                                                                       L_par2,L_par3])

#         L_RecoProb_6 = CustomIndividualLogNorLayer_6(name='RecoNLL_{}'.format(cols_sel[5]))([x_DNN_input,L_par1,
#                                                                       L_par2,L_par3])


#         L_RecoProb_7 = CustomIndividualTruGauLayer_7(name='RecoNLL_{}'.format(cols_sel[6]))([x_DNN_input,L_par1,
#                                                                       L_par2])

#         L_RecoProb_8 = CustomIndividualTruGauLayer_8(name='RecoNLL_{}'.format(cols_sel[7]))([x_DNN_input,L_par1,
#                                                                       L_par2])
...
#         'nBJet30_MV2c10':0
    ...
    name_fold = 'limited_feat_{}_ft_{}'.format('_'.join([str(x) for x in selected_idx]),original_dim)
    ...
    train_vae(name_fold=name_fold, name_weights = name_weights, dictionary=components_dict, w=weights, ind_w = individual_weights,  intermediate_dim=50, act_fun='relu',latent_dim=latent_dim,kernel_max_norm=500, lr=0.003,epochs=2000, weight_KL_loss=0.6, 
              batch_size=200, cols_sel = cols_sel,
              num_train=5, sig_inj = [False])
